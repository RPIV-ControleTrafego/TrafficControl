...
public class AccidentClient {
    ...
    private static AccidentClient instance;
    private final RestTemplate restTemplate;

    @Autowired
    private AccidentClient(RestTemplate restTemplate) {
        this.restTemplate = restTemplate;
    }

    public static AccidentClient getInstance(RestTemplate restTemplate) {
        if (instance == null) {
            instance = new AccidentClient(restTemplate);
        }
        return instance;
    }
