...
public class AdminController {
    ...
    *
    * Ele recebe um objeto do tipo Admin como parâmetro, o salva no repositório e redireciona
    * para a página de índice de administradores.
    *
    ...
    *
    * Ele recebe um objeto do tipo Admin como parâmetro, remove o mesmo do repositório e redireciona
    * para a página de índice de administradores.
    *
    ...
    * 
    * O método busca o administrador no repositório usando o ID fornecido, adiciona-o ao modelo
    * e redireciona para a página de edição "administradores/editAdmin".
    *
    ...
    *
    * O método verifica se o administrador com o ID fornecido existe no repositório. Se
    * existir, as informações do administrador são atualizadas no repositório.
    *
